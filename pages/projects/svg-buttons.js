...
import svgBtnStyles from '../../styles/svg-buttons.css';

export default function Home() {
  return (
    <>
      <Head>
        <title>SVG Buttons | kmDev</title>
      ...
      <button className={svgBtnStyles.button15} role="button">Button 15</button>
      <button className={svgBtnStyles.button19} role="button">Button 19</button>
    </>
  );
}